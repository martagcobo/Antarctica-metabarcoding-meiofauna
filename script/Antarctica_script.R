...
# Filter out controls and non-target samples by sample ID
comm_raw <- comm_raw_base[!rownames(comm_raw_base) %in% non_target_samples, ]
...
partition_summary_df <- data.frame(
  ...
  Pct_Nestedness    = round(c(per_nestedness_plat, per_nestedness_cop, per_nestedness_nem), 2)
)
...
#  [1] iNEXT_3.0.2          writexl_1.5.3        pheatmap_1.0.12      ggraph_2.2.1         tidygraph_1.3.1     
#[6] ggrepel_0.9.6        rlang_1.1.5          officer_0.7.3        flextable_0.9.10     ggmap_4.0.2         
#[11] marmap_1.0.12        rnaturalearth_1.0.1  sf_1.0-19            msa_1.34.0           phangorn_2.12.1     
#[16] DECIPHER_2.30.0      RSQLite_2.4.3        Biostrings_2.70.3    GenomeInfoDb_1.38.8  XVector_0.42.0      
#[21] IRanges_2.36.0       S4Vectors_0.40.2     BiocGenerics_0.48.1  phytools_2.4-4       maps_3.4.2.1        
#[26] ape_5.8-1            ggeffects_2.3.2      pairwiseAdonis_0.4.1 cluster_2.1.6        emmeans_1.10.7      
#[31] car_3.1-3            carData_3.0-5        lme4_1.1-36          Matrix_1.6-5         performance_0.15.1  
#[36] glmmTMB_1.1.10       BAT_2.11.0           vegan_2.6-10         lattice_0.22-5       permute_0.9-7       
#[41] VennDiagram_1.7.3    futile.logger_1.4.9  scales_1.4.0         sjPlot_2.9.0         patchwork_1.3.2     
#[46] lubridate_1.9.4      forcats_1.0.0        stringr_1.5.1        purrr_1.0.4          readr_2.1.5         
#[51] tidyr_1.3.1          tibble_3.2.1         ggplot2_4.0.0        tidyverse_2.0.0      dplyr_1.1.4         

#loaded via a namespace (and not attached):
#  [1] bitops_1.0-9            httr_1.4.7              RColorBrewer_1.1-3      insight_1.4.2          
#[5] doParallel_1.0.17       numDeriv_2016.8-1.1     tools_4.3.3             R6_2.6.1               
#[9] mgcv_1.9-1              withr_3.0.2             sp_2.2-0                gridExtra_2.3          
#[13] prettyunits_1.2.0       textshaping_1.0.0       cli_3.6.4               formatR_1.14           
#[17] mvtnorm_1.3-3           S7_0.2.0                askpass_1.2.1           proxy_0.4-27           
#[21] systemfonts_1.3.1       R.utils_2.13.0          DEoptim_2.2-8           parallelly_1.45.1      
#[25] pdist_1.2.1             rstudioapi_0.17.1       optimParallel_1.0-2     generics_0.1.3         
#[29] shape_1.4.6.1           combinat_0.0-8          zip_2.3.2               abind_1.4-8            
#[33] R.methodsS3_1.8.2       terra_1.8-21            lifecycle_1.0.4         scatterplot3d_0.3-44   
#[37] clusterGeneration_1.3.8 recipes_1.3.1           blob_1.2.4              PlotTools_0.3.1        
#[41] crayon_1.5.3            pillar_1.10.1           knitr_1.49              boot_1.3-29            
#[45] estimability_1.5.1      future.apply_1.20.0     codetools_0.2-19        fastmatch_1.1-6        
#[49] glue_1.8.0              fontLiberation_0.1.0    data.table_1.17.0       vctrs_0.6.5            
#[53] png_0.1-8               Rdpack_2.6.2            gtable_0.3.6            cachem_1.1.0           
#[57] ks_1.14.3               gower_1.0.2             xfun_0.51               rbibutils_2.3          
#[61] prodlim_2024.06.25      pracma_2.4.4            coda_0.19-4.1           reformulas_0.4.0       
#[65] survival_3.5-8          ncdf4_1.24              geometry_0.5.2          timeDate_4041.110      
#[69] iterators_1.0.14        hardhat_1.4.2           units_0.8-5             lava_1.8.1             
#[73] ipred_0.9-15            nlme_3.1-164            bit64_4.6.0-1           fontquiver_0.2.1       
#[77] progress_1.2.3          R.cache_0.17.0          TMB_1.9.16              TreeTools_1.13.1       
#[81] KernSmooth_2.23-22      rpart_4.1.23            colorspace_2.1-1        DBI_1.2.3              
#[85] raster_3.6-32           nnet_7.3-19             mnormt_2.1.1            tidyselect_1.2.1       
#[89] bit_4.5.0.1             compiler_4.3.3          expm_1.0-0              xml2_1.4.0             
#[93] fontBitstreamVera_0.1.1 classInt_0.4-11         quadprog_1.5-8          palmerpenguins_0.1.1   
#[97] digest_0.6.37           minqa_1.2.8             rmarkdown_2.29          htmltools_0.5.8.1      
#[101] pkgconfig_2.0.3         jpeg_0.1-10             fastmap_1.2.0           farver_2.1.2           
#[105] adehabitatMA_0.3.17     jsonlite_1.9.0          mclust_6.1.1            ModelMetrics_1.2.2.2   
#[109] R.oo_1.27.1             nls2_0.3-4              RCurl_1.98-1.17         magrittr_2.0.3         
#[113] Formula_1.2-5           GenomeInfoDbData_1.2.11 gdistance_1.6.5         Rcpp_1.0.14            
#[117] viridis_0.6.5           proto_1.0.0             gdtools_0.4.4           stringi_1.8.4          
#[121] pROC_1.18.5             zlibbioc_1.48.2         MASS_7.3-60.0.1         plyr_1.8.9             
#[125] hypervolume_3.1.5       listenv_0.9.1           graphlayouts_1.2.2      splines_4.3.3          
#[129] hms_1.1.3               uuid_1.2-1              igraph_2.1.4            fastcluster_1.2.6      
#[133] reshape2_1.4.4          futile.options_1.0.1    magic_1.6-1             evaluate_1.0.3         
#[137] lambda.r_1.2.4          tweenr_2.0.3            nloptr_2.1.1            tzdb_0.5.0             
#[141] foreach_1.5.2           polyclip_1.10-7         openssl_2.3.2           future_1.67.0          
#[145] ggforce_0.5.0           xtable_1.8-4            e1071_1.7-16            viridisLite_0.4.2      
#[149] ragg_1.3.3              class_7.3-22            memoise_2.0.1           timechange_0.3.0       
#[153] globals_0.18.0          caret_7.0-1      
